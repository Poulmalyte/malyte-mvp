    ...
    <main style={{ minHeight: '100vh', background: '#F5F7FA', fontFamily: "'Inter', sans-serif" }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 24 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 10 }}>
                <span style={{
                  background: '#EDE9FE', color: '#7C5CFC',
              ...
              <h1 style={{
                ...
                fontSize: 'clamp(24px, 4vw, 32px)', color: '#0F172A',
      ...
      {totalClients > 0 && (
        <div style={{ background: '#EDE9FE', borderBottom: '1px solid #C4B5FD' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', padding: '28px 24px' }}>
            <p style={{
              color: '#7C5CFC', fontSize: 11, fontWeight: 700,
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 24px 120px' }}>
        ...
        {expert.methodology_name && (
          <div style={{
            ...
            <div>
              ...
              <h3 style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 700, fontSize: 17, color: '#0F172A', margin: '0 0 8px' }}>
                {expert.methodology_name}
              </h3>
        ...
        {expert.credentials?.length > 0 && (
          <div style={{ background: '#FFFFFF', borderRadius: 16, padding: '24px 28px', border: '1px solid #E8EDF8', marginBottom: 16 }}>
            <h2 style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 700, fontSize: 16, color: '#0F172A', margin: '0 0 14px' }}>
              Credentials
            </h2>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {expert.credentials.map((c: string, i: number) => (
                <span key={i} style={{
                  ...
                  color: '#7C5CFC', fontSize: 13, fontWeight: 500,
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6, flexWrap: 'wrap' }}>
                        <span style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 700, fontSize: 16, color: '#0F172A' }}>
                          {product.title}
                        </span>
                      ...
                      <span style={{
                        display: 'inline-block', background: '#D1FDF3', color: '#059669',
                    ...
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      <div style={{ fontFamily: 'Satoshi, sans-serif', fontWeight: 800, fontSize: 26, color: '#7C5CFC', marginBottom: 2 }}>
                        €{product.price}
                      </div>
