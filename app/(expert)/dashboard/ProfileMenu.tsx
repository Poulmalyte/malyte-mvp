...
export default function ProfileMenu({ name, email, slug }: Props) {
    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          border: open ? '2px solid #7C5CFC' : '2px solid rgba(124,92,252,0.3)',
      ...
      {open && (
        <div style={{
          ...
          <div style={{ padding: '16px 16px 12px', borderBottom: '1px solid rgba(99,130,255,0.1)' }}>
