          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{ position: 'absolute', right: 4, top: 0, bottom: 0, width: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'none', border: 'none', padding: 0, cursor: 'pointer', color: '#94A3B8' }}
              >
                {showPassword ? (
